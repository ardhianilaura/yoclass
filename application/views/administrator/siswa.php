<div class="container-fluid">
  ...
  <div class="navbar-form navbar-search">
    ...
    <input type="text" name="keyword" class="form-control" placeholder="Search" style="width: 25%" value="<?php echo set_value('keyword'); ?>"><br>
  ...
  <form action="<?= base_url('Siswa/status') ?>" method="get">
      ...
      <button class="btn btn-primary" name="status" value="Lulus" type="submit">Non Aktif</button>
      <button class="btn btn-primary" name="status" value="Keluar" type="submit">Undur Diri</button>
      <button class="btn btn-primary" name="status" value="Lulus" type="submit">Drop Out</button>
      <button class="btn btn-primary" name="status" value="Keluar" type="submit">Lulus</button>
  </form><br>
