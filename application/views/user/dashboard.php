      ...
      <div class="modal-body">
        <div class="row">
          <div class="col-md-3 text-info text-center">           
            ...
            <a href="<?php echo base_url("home2/siswa") ?>"><p class="nav-link small text-info">SISWA</p></a><br>
          </div>

          <div class="col-md-3 text-info text-center">
            <i class="fas fa-3x fa-user-graduate"></i>
            <a href="<?php echo base_url("nilai") ?>"><p class="nav-link small text-info ">INPUT NILAI</p></a>
          </div>

          <div class="col-md-3 text-info text-center">
            <i class="fas fa-3x fa-user-graduate"></i>
            <a href="<?php echo base_url("Nilai/form") ?>"><p class="nav-link small text-info ">IMPORT DATA</p></a>
          </div>

          <div class="col-md-3 text-info text-center">
            <i class="fas fa-3x fa-user-graduate"></i>
            <a href="<?php echo base_url("Nilai/daftar_nilai") ?>"><p class="nav-link small text-info ">DAFTAR NILAI</p></a>
          </div>
